...
if __name__ == '__main__':
    ...
    labels = [json.loads(line) for line in open('C:/Users/arind/Downloads/label_data_0531.json', 'r')]
    sample_no = 299
    for sample_no in range(0, 100, 10):
        lanes = labels[sample_no]['lanes']
        height = labels[sample_no]['h_samples']
        frame = os.path.join('C:/Users/arind/Downloads', labels[sample_no]['raw_file'])
        show_annotated_image(lanes, height, frame, resize=False, save=True, filename=f'image_{sample_no}.png')
    root = 'C:/Users/arind/Downloads/clips/'
    subdirs = ['0601', '0531', '0313-1', '0313-2']
    flabels = ['C:/Users/arind/Downloads/label_data_0601.json',
    ...
    tu_test_dataset = TUSimpleDataset('C:/Users/arind/Downloads/clips/', ['0601'], ['C:/Users/arind/Downloads/label_data_0601.json',
               'C:/Users/arind/Downloads/label_data_0531.json',
               'C:/Users/arind/Downloads/label_data_0313.json'], transforms=data_transform)
